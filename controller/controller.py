...
@st.cache_data(show_spinner=False)                  # Cache the shapefile loading to avoid reloading on every run
def load_amazon_boundary():
    '''
    Loads the shapefile of the Legal Amazon region from disk.
    Returns a GeoDataFrame with the boundary geometry.
    '''
    shapefile_path = SHAPEFILE_AMAZONIA
